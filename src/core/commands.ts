...
export class CommandRouter {
  ...
  transcript: any;
  getPreferredConnector: () => string;
  scanLocalProjects: (...args: any[]) => any;
  currentProjectByIdentity: Map<string, any>;
  lastProjectsByIdentity: Map<string, any>;
  pendingByIdentity: Map<string, any>;
  conversationByIdentity: Map<string, any>;
  threadBindings: Map<string, any>;
  threadSettingsById: Map<string, ThreadSettings>;
  explicitThreadSettingsById: Set<string>;
  maxTurnsPerHour: number;
  turnTimestamps: Map<string, number[]>;
  noticedIdentities: Set<string>;
  greetedIdentities: Set<string>;
  ...
  snapshot() {
    return {
      ...
      explicitThreadSettingsById: [...this.explicitThreadSettingsById],
  ...
  threadTitle(thread: JsonMap | null | undefined, fallback: JsonMap = {}) {
    return (
      thread?.title ??
      thread?.name ??
      thread?.preview ??
...
function formatCurrentModelSettings(settings: JsonMap = {}) {
