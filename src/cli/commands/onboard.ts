...
import type { CliClient, CliCommandContext, CliEnvironment, CliFlags, CliWrite } from "../types.js";
...
export async function runWizard({
  ...
  maxPolls = 1000,
}: { client: CliClient; prompt: (question: string) => Promise<string>; write: CliWrite; env?: CliEnvironment; flags?: CliFlags; sleep?: (ms: number) => Promise<unknown>; maxPolls?: number }) {
